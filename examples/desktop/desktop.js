...
function createWindow(){
    ...
    var w = Desktop.createWindow({
        ...
        content: "<div class='p-2'>#clubcodigocero Escritorio</div>"
    });

    setTimeout(function(){
        w.setContent("Crear Nueva Ventana!");
    }, 3000);
}



function createWindowtoURL(thisURL, twidth=700, theight=600){
    var index = Metro.utils.random(0, 3);
    var w = Desktop.createWindow({
        resizeable: true,
        draggable: true,
        ...
        icon: "<span class='mif-"+w_icons[index]+"'></span>",
        title: w_titles[index],
        content: "<div class=embed-container><iframe src='"+thisURL+"'></iframe></div>"
    });
}
...
function createWindowWithCustomButtons(){
    ...
    Desktop.createWindow({
        ...
        icon: "<span class='mif-"+w_icons[index]+"'></span>",
        title: w_titles[index],
        content: "<div class='p-2'>Este demo fue creado por #clubcodigocero usando Metro 4 Components Library.<br><br>Este ventanta tiene botones!!!! ;)</div>"
    });
}
...
function createWindowModal(){
    Desktop.createWindow({
        ...
        title: "Modal window",
        content: "<div class='p-2'>Este demo fue creado por #clubcodigocero usando Metro 4 Components LibraryLibrary</div>",
        overlay: true,
...
function createWindowYoutube(){
    Desktop.createWindow({
        ...
        title: "Codigo Cero",
        content: "https://youtu.be/sWH7sG9Y5h4",
        clsContent: "bg-dark"
    });
}
